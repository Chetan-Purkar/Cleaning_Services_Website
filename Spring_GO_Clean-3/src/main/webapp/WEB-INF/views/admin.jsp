...
<head>
    ...
    <title>Car Cleaning App Admin Login</title>
...
<body>
    ...
    <div id="Userlogin">
        <form class="inner" action="/admin" method="post">
            <span id="Error">
            ...
            <h4>User Name</h4>
            <input type="text" class="username" name="username" placeholder="Enter Admin Name" required>
            ...
            <a href="/adminregister" id="Login"> Create New Account</a>
        </form>
    </div>
    <footer>
        <div id="foot">
